...
def attack(char_name: str, char_class: str) -> str:
    """Функция запускает атаку игрока."""
...
def defence(char_name: str, char_class: str) -> str:
    """Блокирует урон игрока, взависимости от выбранного персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Применяет специальное умение, взависимости от выбранного персонажа."""
    if char_class == 'warrior':
